...
rm EngineEditor/Engine.mk
rm EngineEditor/Engine.project
rm EngineEditor/Engine.txt
...
rm SandboxApp/Engine.mk
rm SandboxApp/Engine.project
rm SandboxApp/Engine.txt
