...
//based on imgui.h file version "1.80 WIP" from Dear ImGui https://github.com/ocornut/imgui
...
typedef enum {
    ...
    ImGuiTableFlags_ColumnsWidthStretch = 1 << 13,
    ImGuiTableFlags_ColumnsWidthFixed = 1 << 14,
...
typedef enum {
    ...
    ImGuiTableColumnFlags_WidthAutoResize = 1 << 4,
...
CIMGUI_API bool igBeginTable(const char* str_id,int columns_count,ImGuiTableFlags flags,const ImVec2 outer_size,float inner_width);
...
CIMGUI_API void igTableSetBgColor(ImGuiTableBgTarget bg_target,ImU32 color,int column_n);
...
CIMGUI_API float igTableGetMinColumnWidth(void);
